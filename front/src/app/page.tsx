    ...
    <>
      <section className="relative px-8 sm:min-h-screen max-sm:pb-20 overflow-visible">
        ...
        <div className="flex flex-col items-end justify-end max-xl:justify-center max-xl:items-center">
          <h2 className="text-7xl tracking-widest text-teal-500 text-right pt-4 pb-2 font-extrabold xl:max-w-xl max-sm:text-5xl max-xl:text-center max-xl:mix-blend-multiply max-xl:text-teal-800">
